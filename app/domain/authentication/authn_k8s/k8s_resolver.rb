    ...
    module K8sResolver
      ...
      class Deployment < Base
        def validate_pod
          ...
          verify "Pod #{pod.metadata.name.inspect} Deployment is #{deployment.metadata.name.inspect}, not #{name.inspect}" do
      ...
      class DeploymentConfig < Base
        def validate_pod
          ...
          verify "Pod #{pod.metadata.name.inspect} DeploymentConfig is #{deployment_config.metadata.name.inspect}, not #{name.inspect}" do
      ...
      class ReplicaSet < Base
        def validate_pod
          ...
          verify "Pod #{pod.metadata.name.inspect} ReplicaSet is #{replica_set.metadata.name.inspect}, not #{name.inspect}" do
      ...
      class ServiceAccount < Base
        def validate_pod
          verify "Pod #{pod.metadata.name.inspect} assigned ServiceAccount #{pod.spec.serviceAccountName.inspect}, not #{name.inspect}" do
      ...
      class StatefulSet < Base
        def validate_pod
          ...
          verify "Pod #{pod.metadata.name.inspect} StatefulSet name is #{stateful_set.metadata.name.inspect}, not #{name.inspect}" do
      ...
      class Pod < Base
        ...
        def validate_pod
          verify "Pod #{pod.metadata.name.inspect} is not #{name.inspect}" do
